...
**실측 (비트겟 BTCUSDT, 2026-08-18 ~ 08-31, 40회 정산)**

    평균 +0.0050%/8h   표준편차 0.0054%   음수 15%
    40회 중 13회가 정확히 +0.0100% — 여기가 상한선이다

그리고 왕복 수수료(현물 0.10% + 선물 0.06%, 양방향)를 덮는 데만
**약 21일**이 걸린다. 짧게 들어갔다 나오면 확정 손실이다.

**실측 (바이낸스 BTC-USDT, 2020-01 ~ 2023-12, 4,383회)**

    전체 평균 +0.0137%/8h   중앙값 +0.0100%   음수 13%

    2020 +0.0157%   2021 +0.0280%   2022 +0.0038%   2023 +0.0072%
    수수료까지 넣고 돌리면 1배 기준 +10.0% / +15.4% / +1.3% / +3.9%

**국면이 전부다. 연 1.3%에서 24.7%까지 벌어진다.**

그리고 이 전략의 핵심 결함: 30일 창 1,431개에서 평균 펀딩률과 같은 기간
BTC 수익률의 상관이 **+0.33**이다.

    펀딩 하위 25%  +0.0010%/8h  →  BTC  -2.7%
    펀딩 상위 25%  +0.0382%/8h  →  BTC +14.4%

**많이 벌리는 때가 곧 숏 다리가 녹는 때다.** 수익과 위험이 다른 사건이
아니라 같은 사건이다. 실제로 2020년 상승장에서 1배 포지션이 두 번
축소되다 전량 정리됐다 — 가장 잘 벌던 구간에서 포지션이 사라졌다.
"""
